...
void move_student(struct dorm_t *dorm, struct student_t *mhs, char *nim, char *asrama, int zstd, int zdrm, int find_id(char *nim, int stdn, struct student_t *mhs), int find_dorm(char *asrama, int asrm, struct dorm_t *dorm));
